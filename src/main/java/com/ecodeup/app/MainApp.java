...
public class MainApp {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub - Marcos Gonzalez
		...
		// trae toda la conexion de la base de datos
		...
		while (opcion!=5) {
			...
			case 1:
				...
				entity.getTransaction().begin(); // JDBC que empiece la transaccion
				entity.persist(producto); // Guarda el Objeto en la base de datos
				entity.getTransaction().commit(); // Finaliza la transaccion y que se haga commit el la base de datos
			...
			case 3:
				...
				if (producto != null) {
					...
					entity.merge(producto); // Se le pasa el nuevo prod
